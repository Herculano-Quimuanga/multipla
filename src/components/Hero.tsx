        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-5">
              <h1 className="text-4xl md:text-4xl lg:text-5xl font-bold text-white leading-none mt-10" data-aos="fade-right">
                Juntos tornamos
              ...
              <p className="text-xl text-gray-200 max-w-2xl" data-aos="fade-right" data-aos-delay="300">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3" data-aos="fade-right" data-aos-delay="500">
              ...
              <div className="flex items-center space-x-3" data-aos="fade-right" data-aos-delay="700">
                <CheckCircle className="w-5 h-5 text-primary-glow flex-shrink-0" />
                <span className="text-gray-200">Suporte técnico especializado 24/7</span>
              </div>
              <div className="flex items-center space-x-3" data-aos="fade-right" data-aos-delay="900">
                <CheckCircle className="w-5 h-5 text-primary-glow flex-shrink-0" />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="btn-corporate group" data-aos="zoom-in">
                Começar Agora
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </Button>
              <Button className="btn-outline-corporate" data-aos="zoom-in" data-aos-delay="300">
                Agendar Consultoria
              </Button>
            </div>
          </div>
